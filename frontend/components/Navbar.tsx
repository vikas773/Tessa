    ...
    <nav className="bg-white/80 backdrop-blur-md sticky top-0 z-50 w-full mb-0 px-8 py-4 flex items-center justify-between border-b border-slate-100">
      ...
      <div className="flex items-center gap-4">
        <div className="h-10 w-10 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600 font-bold">
          {userInitial || <svg className="w-6 h-6 text-slate-400" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path></svg>}
        </div>
      </div>
    </nav>
  );
