    ...
    <div className="flex h-screen w-full bg-[#1e293b] text-slate-100 overflow-hidden font-sans">
      ...
      <aside className="w-72 bg-[#0f172a] border-r border-slate-800/50 flex flex-col pt-8 pb-6 px-6 shrink-0 relative z-20">
        ...
        <nav className="flex-1 space-y-2">
          <Link href="/" className="flex items-center gap-3 px-4 py-3 bg-blue-600/10 text-blue-400 rounded-xl font-bold transition-all border border-blue-500/20 shadow-[0_0_15px_-3px_rgba(59,130,246,0.15)]">
          ...
          <Link href="/assets" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-slate-800/50 hover:border-slate-700 border border-transparent rounded-xl font-bold transition-all">
          ...
          <Link href="/employees" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-slate-800/50 hover:border-slate-700 border border-transparent rounded-xl font-bold transition-all">
      ...
      <main className="flex-1 overflow-y-auto relative z-10 custom-scrollbar">
        <div className="max-w-7xl mx-auto px-8 py-10 lg:px-12 lg:py-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Quick Shortcuts */}
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-8 rounded-2xl text-white shadow-xl shadow-blue-900/20 relative overflow-hidden group">
      ...
      {/* Global CSS enhancements for scrollbars */}
