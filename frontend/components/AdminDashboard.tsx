    ...
    <div className="max-w-7xl mx-auto">
      <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white">Systems Overview</h2>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {[
          ...
          { label: 'Active Reports', value: stats?.maintenance_assets ?? 0, color: '#F59E0B', bg: 'rgba(245,158,11,0.1)', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
        ].map((stat, i) => (
